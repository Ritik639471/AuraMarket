...
const seedData = async () => {
    try {
        ...
        const productsData = [
            // Fashion
            { name: 'Aura Premium Silk Saree', description: 'Handcrafted traditional elegance for every occasion.', price: 120, category: 'Fashion', stock: 25, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1583391733958-d698188bd0d4?auto=format&fit=crop&q=80'] },
            { name: 'Men Classic Denim Jacket', description: 'Vintage wash, durable denim perfect for casual wear.', price: 85, category: 'Fashion', stock: 40, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1576995853123-5a10305d93c0?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&q=80'] },
            { name: 'Women Summer Floral Dress', description: 'Light, breathable cotton dress for warm days.', price: 55, category: 'Fashion', stock: 30, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1515347619252-19e487a552dc?auto=format&fit=crop&q=80'] },

            // Electronics
            { name: 'MacBook Pro M3 Max', description: 'Ultimate power for pros. Liquid Retina XDR display.', price: 3499, category: 'Electronics', stock: 15, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1517336714468-450583ad716d?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?auto=format&fit=crop&q=80'] },
            { name: 'Sony Noise Cancelling Headphones', description: 'Industry-leading noise cancellation and premium audio.', price: 298, category: 'Electronics', stock: 50, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&q=80'] },
            { name: 'Samsung Galaxy S24 Ultra', description: 'Titanium frame, AI features, and 200MP camera.', price: 1299, category: 'Electronics', stock: 20, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1598327105666-5b89351cb315?auto=format&fit=crop&q=80'] },

            // Bags
            { name: 'Classic Leather Tote', description: 'Spacious and durable. Perfect for daily essentials.', price: 150, category: 'Bags', stock: 30, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1584917033904-493bb3c3d1aa?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1591561954557-26941169b49e?auto=format&fit=crop&q=80'] },
            { name: 'Adventure Hiking Backpack', description: 'Water-resistant, ergonomic design with laptop sleeve.', price: 90, category: 'Bags', stock: 45, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1505322022379-7c3353ee6291?auto=format&fit=crop&q=80'] },
            
            // Footwears
            { name: 'Aura Ultra-Lite Sneakers', description: 'Engineered for comfort and speed. Modern aesthetic.', price: 85, category: 'Footwears', stock: 50, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1608231387042-66d1773070a5?auto=format&fit=crop&q=80'] },
            { name: 'Formal Oxford Leather Shoes', description: 'Hand-stitched Italian leather for professional wear.', price: 120, category: 'Footwears', stock: 35, shopkeeper: demoShopkeeper._id, images: ['https://images.unsplash.com/photo-1614252339460-e144a95a8f4c?auto=format&fit=crop&q=80', 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?auto=format&fit=crop&q=80'] },
